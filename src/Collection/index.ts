...
export class WlindablaFieldCollectionManager implements FieldCollectionInterface {
    ...
    public init = (class_btn: string = '.wlindabla-collection-add',
        subject: Window | Document | HTMLElement): void => {
    ...
    public addRemoveButtonToField(containerRow: JQuery<HTMLDivElement | HTMLElement>): void {
        ...
        remove_btn.attr({ type: 'button' }).prepend('<i class="fas fa-trash" aria-hidden="true"></i>');
