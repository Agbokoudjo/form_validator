 ...
 */
import { MediaValidatorInterface, OptionsValidateTypeFile } from '.';
import { FormError } from '../FormError';
import { convertOctetToMo } from "../../_Utils"
export abstract class AbstractMediaValidator extends FormError implements MediaValidatorInterface {
    protected constructor() {
        super();
    }
    public abstract fileValidator: (media: File | FileList, targetInputname: string, optionsfile: OptionsValidateTypeFile) => Promise<this>;
    /**
