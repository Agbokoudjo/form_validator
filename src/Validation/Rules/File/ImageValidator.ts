...
export class ImageValidator extends AbstractMediaValidator implements MediaValidatorInterface {
    ...
    public validate = async (
        ...
        for (const file of files) {
            this.extensionValidate(file, targetInputname, optionsimg.extensions); // Validation de l'extension dans la même boucle
    ...
    */
    private validateImage(src: string | File, config?: { throw: boolean; }): Promise<boolean | undefined> {
